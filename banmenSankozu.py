...
def list_tograph_sanko(
    ...
    #持ち駒
    sente_mochigoma = '☗' + '先手' + ' ' + (sente_mochigoma.replace("二","２").replace("三","３").replace("四","４").replace("五","５")
    .replace("六","６").replace("七","７").replace("八","８").replace("九","９"))

    koute_mochigoma = '☖' + '後手' + ' ' + (koute_mochigoma.replace("二","２").replace("三","３").replace("四","４").replace("五","５")
    .replace("六","６").replace("七","７").replace("八","８").replace("九","９"))
    ...
    for k in range(len(dan)):
        for i in range(len(dan[k])):
            ...
            if dan[k][i][0] == 'v' and dan[k][i][1] == '杏':
                moji = komafont['杏']
                ax.text(i + 1.5,y,moji, ha='center',va='center',rotation=rot,fontsize='8.5',fontweight=1000,family=KOMA_FONT)
                ...
                if dan[k][i][0] == 'v' and dan[k][i][1] == '龍':
                    ax.text(i + 1.5,y,moji, ha='center',va='center',rotation=rot,fontsize='9',fontweight=1000,family=KOMA_FONT)
