...
def list_tograph_toryo(
    ...
    #持ち駒
    sente_mochigoma = '☗' + str(sente_name) + ' ' + (sente_mochigoma.replace("二","２").replace("三","３").replace("四","４")
    .replace("五","５").replace("六","６").replace("七","７").replace("八","８").replace("九","９"))

    koute_mochigoma = '☖' + str(koute_name) + ' ' + (koute_mochigoma.replace("二","２").replace("三","３").replace("四","４").
    replace("五","５").replace("六","６").replace("七","７").replace("八","８").replace("九","９"))
